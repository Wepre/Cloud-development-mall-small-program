...
Page({
  ...
  if (arr) {
    ...
    console.log(array)
    wx.navigateTo({
      url: '../shop_order/shop_order?array='+array+'&productAll='+productAll+'&iscar='+this.dataiscar,
    })
  }
  },
